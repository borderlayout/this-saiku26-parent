var ChartEditor = Backbone.View.extend({
    ...
    + '</ul><span class="logo">'
    + '<a class="saiku sprite" title="Creditease - Next Generation Open Source Analytics" href="http://crdc.creditease.cn"></a>'
+ '<a class="ccc" title="CCC2" href="http://crdc.creditease.cn"></a>'
    + '</span> </div>'
